...
public class BaseInnerProcessedTaskAction extends BaseProcessedTaskAction {
    ...
    protected void addNlgGuidesInfoToMap(Map<String, BizDataModelState<String>> bizDataMapTmp, NlgGuidesInfo nlgGuidesInfo, int keepTurnCount) {
        ...
        String issue = nlgTemplateInfo.getNlgTemplate();
        ...
        addToBizDataMSMap(bizDataMapTmp, BC.SCRIPT, issue, keepTurnCount);
        addToBizDataMSMap(bizDataMapTmp, BC.NLG_TEMPLATE_INFO_JS, nlgTemplateInfoJS, keepTurnCount);
        addToBizDataMSMap(bizDataMapTmp, BC.GUIDE_OPTIONS_JS, guideOptionsJS, keepTurnCount);
    }
}
